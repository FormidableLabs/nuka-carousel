...
| animation                 | `React.PropTypes.oneOf(['zoom'])`                                                                | When displaying at least 3 slides, adds a zoom effect on the currently visible slide. A ```transform: scale(.85)``` property is applied on all slides except the current 1                                                                                                                                                   |                                                                           |
| slideLeftOffset                 | `React.PropTypes.number`                                                                 | While using prop ```animation = "zoom"```, you can configure space around current slide with slideLeftOffset.                                                                                                                                                 |                                                                           |
