...
function (_React$Component) {
  ...
  function Carousel() {
    ...
    _this.totalSlides = _this.totalSlides.bind(_assertThisInitialized(_this));
    ...
    _this.dimensionsChanged = _this.dimensionsChanged.bind(_assertThisInitialized(_this));
    ...
    _this.getSlideWidth = _this.getSlideWidth.bind(_assertThisInitialized(_this));
    _this.getFrameWidth = _this.getFrameWidth.bind(_assertThisInitialized(_this));
    _this.findMaxHeightSlide = _this.findMaxHeightSlide.bind(_assertThisInitialized(_this));
    _this.shouldRenderSlide = _this.shouldRenderSlide.bind(_assertThisInitialized(_this));
  ...
  _createClass(Carousel, [{
    ...
    value: function shouldRenderSlide(index) {
      var _props = this.props,
          ...
          placeholderMode = _props.placeholderMode,
          preloadedChildrenLevel = _props.preloadedChildrenLevel,
