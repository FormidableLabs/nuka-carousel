...
var Carousel = _react2['default'].createClass({
  ...
  nextSlide: function nextSlide() {
    ...
    if (this.props.wrapAround) {
      ...
      if (this.state.slidesToScroll > 1 && this.state.currentSlide + this.state.slidesToScroll >= lastChild) {
        return this.goToSlide(Math.min(this.state.currentSlide + this.state.slidesToScroll, childrenCount - slidesToShow));
      }
      this.goToSlide(Math.min(this.state.currentSlide + this.state.slidesToScroll, childrenCount));
    }
  },
