...
var Carousel = _react2['default'].createClass({
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    this.setState({
      slideCount: _react2['default'].Children.toArray(nextProps.children).filter(function (c) {
  ...
  render: function render() {
    ...
    var children = _react2['default'].Children.toArray(this.props.children).filter(function (c) {
      return _react2['default'].isValidElement(c);
    }).length > 1 ? this.formatChildren(this.props.children) : this.props.children;
  ...
  handleSwipe: function handleSwipe(e) {
    ...
    if (this.touchObject.length > this.state.slideWidth / this.props.slidesToShow / 5) {
      if (this.touchObject.direction === 1) {
        if (this.state.currentSlide >= _react2['default'].Children.toArray(this.props.children).filter(function (c) {
          return _react2['default'].isValidElement(c);
        }).length - this.props.slidesToShow) {
  ...
  goToSlide: function goToSlide(index) {
    var self = this;
    if (index >= _react2['default'].Children.toArray(this.props.children).filter(function (c) {
      return _react2['default'].isValidElement(c);
    }).length || index < 0) {
      return;
    }
  ...
  nextSlide: function nextSlide() {
    var childrenCount = _react2['default'].Children.toArray(this.props.children).filter(function (c) {
      return _react2['default'].isValidElement(c);
    }).length;
  ...
  setInitialDimensions: function setInitialDimensions() {
    ...
    this.setState({
      ...
      slideCount: _react2['default'].Children.toArray(this.props.children).filter(function (c) {
        return _react2['default'].isValidElement(c);
      }).length,
  ...
  getListStyles: function getListStyles() {
    var listWidth = this.state.slideWidth * _react2['default'].Children.toArray(this.props.children).filter(function (c) {
      return _react2['default'].isValidElement(c);
    }).length;
    var spacingOffset = this.props.cellSpacing * _react2['default'].Children.toArray(this.props.children).filter(function (c) {
      return _react2['default'].isValidElement(c);
    }).length;
    return {
      position: 'relative',
