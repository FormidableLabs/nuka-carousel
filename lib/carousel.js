...
var Carousel = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    contentAlign: _propTypes2.default.oneOfType([_propTypes2.default.oneOf(['left', 'center', 'right']), _propTypes2.default.func])
  },
  ...
  componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
    ...
    if (this.props.slideIndex !== prevProps.slideIndex && this.props.slideIndex !== this.state.currentSlide) {
    ...
    return _react2.default.createElement(
      ...
      this.props.decorators ? this.props.decorators.map(function (Decorator, index) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(Decorator.component, _extends({
  ...
  getInitialDimensions: function getInitialDimensions() {
    var slideWidth, frameHeight, slideHeight;
  ...
  setDimensions: function setDimensions(props) {
    ...
    var slidesArray = Array.prototype.slice.call(frame.childNodes[0].childNodes);
    var heights = slidesArray.map(function (slide) {
      return slide.offsetHeight;
    });
    var maxHeight = Math.max.apply(null, heights);
    var highestSlide = slidesArray.filter(function (slide) {
      return slide.offsetHeight === maxHeight;
    });
  ...
  getSlideStyles: function getSlideStyles(index, positionValue) {
    ...
    var textAlign = this.getContentAlign(index);
    return {
      textAlign: textAlign,
      position: 'absolute',
  ...
  getContentAlign: function getContentAlign(index) {
