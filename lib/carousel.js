...
var Carousel = _react2['default'].createClass({
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _extends({ className: 'slider-frame',
          ref: 'frame',
          style: (0, _objectAssign2['default'])(this.getFrameStyles(), this.props.frameStyle || {})
        }, this.getTouchEvents(), this.getMouseEvents(), {
          onClick: this.handleClick }),
        _react2['default'].createElement(
          'ul',
          { className: 'slider-list', ref: 'list', style: (0, _objectAssign2['default'])(this.getListStyles(), this.props.listStyle || {}) },
          children
        )
      ),
  ...
  formatChildren: function formatChildren(children) {
    ...
    return _react2['default'].Children.map(children, function (child, index) {
      return _react2['default'].createElement(
        'li',
        { className: 'slider-slide', style: (0, _objectAssign2['default'])(self.getSlideStyles(), self.props.slideStyle || {}), key: index },
        child
      );
    });
  },
