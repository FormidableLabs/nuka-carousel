    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          _extends({ className: 'slider-frame', ref: 'frame',
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleSwipe = function (e) {
    ...
    if (_this3.touchObject.length > _this3.state.slideWidth / slidesToShow / 5) {
      if (_this3.touchObject.direction === 1) {
        if (_this3.state.currentSlide >= _this3.totalSlides() - slidesToShow && !_this3.props.wrapAround) {
  ...
  this.goToSlide = function (index) {
    if (index >= _this3.totalSlides() || index < 0) {
      if (!_this3.props.wrapAround) {
        return;
      }
      if (index >= _this3.totalSlides()) {
        ...
        var endSlide = _this3.totalSlides() - _this3.state.slidesToScroll;
  ...
  this.nextSlide = function () {
    var childrenCount = _this3.totalSlides();
    var slidesToShow = _this3.props.slidesToShow;
    if (_this3.props.slidesToScroll === 'auto') {
      slidesToShow = _this3.state.slidesToScroll;
    }
  ...
  this.shouldRenderSlide = function (index) {
    ...
    var currentSlide = _this3.state.currentSlide;
    var totalPreloadedSlides = 2 * preloadedChildrenLevel + 1;
    var totalSlides = _this3.totalSlides();
  ...
  this.formatChildren = function () {
    ...
    var positionValue = vertical ? _this3.getTweeningValue('top') : _this3.getTweeningValue('left');
    return children.map(function (slide, index) {
      return _react2.default.createElement(
        'li',
        { className: 'slider-slide', style: _this3.getSlideStyles(index, positionValue), key: index },
        _this3.shouldRenderSlide(index) ? Slide && _react2.default.createElement(Slide, slide) : _react2.default.createElement(Placeholder, slide)
      );
    });
  };

  this.totalSlides = function () {
    return _this3.props.children ? _this3.props.children.length : 0;
  };
  ...
  this._activeSlideReference = function () {
    var frame = _this3.refs.frame;
    return frame.childNodes[0].childNodes[_this3.state.currentSlide];
  };

  this.updateDimensions = function () {
    var frame = _this3.refs.frame;
    var targetSlide = _this3._activeSlideReference();

    var slideHeight = _this3._slideHeight(targetSlide, _this3.props);
  ...
  this.setDimensions = function (targetProps) {
    ...
    var slideHeight = _this3._slideHeight(targetSlide, props);
  ...
  this.getListStyles = function () {
    var listWidth = _this3.state.slideWidth * _this3.totalSlides();
    var spacingOffset = _this3.props.cellSpacing * _this3.totalSlides();
  ...
  this.getFrameStyles = function () {
    return {
      ...
      padding: _this3.props.framePadding,
      margin: 0,
  ...
  this.getSlideTargetPosition = function (index, positionValue) {
    var _props3 = _this3.props,
        ...
        cellSpacing = _props3.cellSpacing;
...
Carousel.propTypes = {
  ...
  placeholderMode: _propTypes2.default.bool,
  preloadedChildrenLevel: _propTypes2.default.number,
