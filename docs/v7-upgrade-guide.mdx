...
- [`tabbed`](api#tabbed) determines whether roles should follow the WCAG tabbed carousel requirements.
- [`landmark`](api#landmark) prop determines whether role should be a region landmark or have role group.
- [`carouselId`](api#carouselid) prop gives the carousel frame an id attribute which can be uniquely targeted by controls.
