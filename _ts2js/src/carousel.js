...
class Carousel extends React.Component {
    ...
    render() {
        ...
        return (<div className={['slider', this.props.className || ''].join(' ')} ref="slider" style={Object.assign({}, this.getSliderStyles(), this.props.style)}>
        ...
        {this.props.decorators ?
            this.props.decorators.map((Decorator, index) => (<div style={Object.assign({}, this.getDecoratorStyles(Decorator.position), (Decorator.style || {}))} className={'slider-decorator-' + index} key={index}>
              <Decorator.component currentSlide={this.state.currentSlide} slideCount={this.state.slideCount} frameWidth={this.state.frameWidth} slideWidth={this.state.slideWidth} slidesToScroll={this.state.slidesToScroll} cellSpacing={this.props.cellSpacing} slidesToShow={this.props.slidesToShow} wrapAround={this.props.wrapAround} nextSlide={this.nextSlide} previousSlide={this.previousSlide} goToSlide={this.goToSlide}/>
            </div>)) : null}
    ...
    animateSlide(easing, duration, endValue, callback) {
        this.props.tweenState(this.props.vertical ? 'top' : 'left', {
    ...
    formatChildren(children) {
        var self = this;
        var positionValue = this.props.vertical ? this.props.getTweeningValue('top') : this.props.getTweeningValue('left');
    ...
    setDimensions(props) {
        ...
        var slideWidth, slidesToScroll, firstSlide, frame, frameWidth, frameHeight, slideHeight;
    ...
    getListStyles() {
        ...
        var transform = 'translate3d(' +
            this.props.getTweeningValue('left') + 'px, ' +
            this.props.getTweeningValue('top') + 'px, 0)';
        console.log('------------------');
        ...
        return {
            ...
            msTransform: 'translate(' +
                this.props.getTweeningValue('left') + 'px, ' +
                this.props.getTweeningValue('top') + 'px)',
            position: 'relative',
            display: 'block',
...
//   }
// }
export default tweenState.tweenMixin(Carousel);
