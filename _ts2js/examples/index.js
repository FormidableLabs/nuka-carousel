...
const App = createReactClass({
    ...
    render() {
        ...
        <Carousel ref="carousel" autoplay={false} wrapAround speed={1000} autoplayInterval={1000} resetAutoplay={false} swipeSpeed={35} slideIndex={this.state.slideIndex} afterSlide={newSlideIndex => this.setState({ slideIndex: newSlideIndex })}>
