...
> :warning: Nuka-Carousel v4 is no longer maintained, if you have any questions about v4 please raise an issue or start discussion and we will help tackle the issue. Currently v5 is our main priority and we recommend to migrate to v5. The migration guide is under development, expect it soon.

> :warning: If you want to install specific v4 version of the library, you need to run `npm install nuka-carousel@4.8.4` or `yarn add nuka-carousel@4.8.4` for example.
