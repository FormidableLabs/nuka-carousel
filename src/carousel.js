  ...
  goToSlide(index) {
    ...
    if (index >= count || index < 0) {
      ...
      if (index >= count) {
        ...
        currentSlide = count - this.state.slidesToScroll;
      }
    }

    this.props.beforeSlide(this.state.currentSlide, currentSlide);
    ...
    this.setState(
      ...
      function() {
        self.animateSlide(
          null,
          null,
          self.getTargetLeft(null, currentSlide),
          function() {
            self.animateSlide(null, 0.01);
            self.props.afterSlide(currentSlide);
            self.resetAutoplay();
